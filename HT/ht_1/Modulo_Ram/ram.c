...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Modulo de RAM, Laboratorio SO 1");
...
{
    proc_create("ram_201325641", 0, NULL, &operaciones);
    printk(KERN_INFO "201325641\n");
    return 0;
}
...
{
    remove_proc_entry("ram_201325641", NULL);
